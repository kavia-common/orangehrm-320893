Feature: PIM (Personal Information Management)
  ...
  # All scenarios in this BDD suite are intended to be discovery/dry-run safe by default.
  # They validate step bindings and business intent without launching a browser.
